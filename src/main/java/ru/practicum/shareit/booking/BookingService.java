...
public interface BookingService {
    ...
    List<BookingResponseDto> getByBookerId(long bookerId, String state, int from, int size);

    List<BookingResponseDto> getByOwnerId(long ownerId, String state, int from, int size);
}